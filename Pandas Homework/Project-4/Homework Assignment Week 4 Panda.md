...
mergeID = pd.merge(itemmerge, dupitem, left_index = True, right_on = 'Item ID')
mergeID
```
...
```
    ...
    C:\Users\Owner\Anaconda3\envs\PythonData2\lib\site-packages\pandas\core\frame.py:3027: SettingWithCopyWarning: 
...
On the Gender Demographics:
-Males make up over 80 percent of players. 
-The males also make over 80% of the revenue.
